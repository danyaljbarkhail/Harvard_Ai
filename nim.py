...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        # Search through all possible actions
        # For the one that leads to the highest q value
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # Get the best action / q_value pair
        ...
        # If no good moves, return a random move
        if highest_q_value == 0:
            return random.choice(tuple(available_actions))
        
        # If epsilon, return a random move
        if epsilon:
